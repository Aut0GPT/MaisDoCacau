...
export const products: Product[] = [
  {
    ...
    price: 28.90,
    image: '/images/products/amendoadecacaucaramelizada125g.svg',
  ...
  },
  {
    ...
    price: 89.90,
    image: '/images/products/Cauchacaarmazenadaembarrildecarvalho500ml.svg',
  ...
  },
  {
    ...
    price: 29.90,
    image: '/images/products/CauchacaArmazenadaembarrildecarvalho30ml.svg',
    category: ProductCategory.ALCOHOL,
    weight: '30ml',
    featured: false,
    new: true,
  ...
  },
  {
    ...
    price: 18.50,
    image: '/images/products/ChadeCacau30gpartedafrente.svg',
  ...
  },
  {
    ...
    price: 24.90,
    image: '/images/products/GranolaBaiana150gpartedafrente.svg',
    category: ProductCategory.SNACK,
    weight: '150g',
    featured: true,
    new: false,
  ...
  },
  {
    ...
    price: 32.90,
    image: '/images/products/Melldecacau175ml.svg',
  ...
  },
  {
    ...
    price: 38.50,
    image: '/images/products/Mellato140g.svg',
    category: ProductCategory.CONDIMENT,
    weight: '140g',
    featured: false,
    new: true,
  ...
  },
  {
    ...
    price: 45.90,
    image: '/images/products/MelldeCacau1litro.svg',
  ...
  },
  {
    ...
    price: 19.90,
    image: '/images/products/NibsdeCacau50g.svg',
    category: ProductCategory.SNACK,
    weight: '50g',
    featured: true,
    new: false,
  ...
  },
  {
    ...
    price: 34.90,
    image: '/images/products/VinagreBalsamicodeCacau250ml.svg',
    category: ProductCategory.CONDIMENT,
    weight: '250ml',
    featured: false,
    new: false,
  ...
  },
  {
    ...
    price: 29.90,
    image: '/images/products/Vinagredecacau250ml.svg',
    category: ProductCategory.CONDIMENT,
    weight: '250ml',
    featured: false,
    new: true,
  ...
  },
  {
    ...
    price: 59.90,
    image: '/images/products/CauchacaOriginal160ml.svg',
    category: ProductCategory.ALCOHOL,
    weight: '160ml',
    featured: true,
    new: false,
